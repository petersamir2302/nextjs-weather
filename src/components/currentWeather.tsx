...
interface WeatherData {
  ...
  const CurrentWeather = ({ weatherData, isMetric }: Props) => {
        ...
        <div className='card bg-white bordered rounded p-4 mb-3'>
            ...
            <div className='d-flex gap-5'>
                <div className='flex-1 d-flex flex-column'>
                    ...
                    <div className='d-flex gap-2'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="#0d6efd" className="bi bi-moisture" viewBox="0 0 16 16">
